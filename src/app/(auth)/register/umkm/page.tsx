  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.data) {
        setCurrentUser({
          id: data.data.id,
          nama: data.data.namaPemilik,
          namaUsaha: data.data.namaUsaha,
        ...
        <div className="bg-white p-6 sm:p-10 rounded-3xl shadow-xl border border-[#E6DFD5] max-w-md w-full text-center space-y-6 animate-in fade-in zoom-in-95 duration-200">
          ...
          <div className="space-y-2">
            ...
            <h2 className="text-2xl font-extrabold text-gray-900 tracking-tight">
              Selamat Datang, {formData.namaUsaha}!
            </h2>
            <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
              Akun UMKM Anda telah berhasil dibuat. Anda dapat langsung masuk ke dashboard untuk melihat marketplace dan menyiapkan proyek.
            </p>
          </div>
          ...
          <div className="p-4 bg-[#FFF7F3] border border-[#FFD9CA] rounded-2xl text-left space-y-2">
            <p className="text-xs text-[#964825] leading-relaxed">
              <strong>Info Verifikasi:</strong> Akun Anda berstatus awal <em>Menunggu Verifikasi</em>. Admin akan meninjau kelengkapan profil Anda, namun Anda sudah dapat langsung menjelajahi dashboard UMKM.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3 pt-2">
            ...
            >
              <span>Masuk ke Dashboard UMKM Sekarang</span>
            ...
            >
              <span>Jelajahi Marketplace Talenta</span>
            </Link>
          </div>
        </div>
      </div>
